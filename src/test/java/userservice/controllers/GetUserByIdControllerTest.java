 ...
 *
 * <p>This test class validates the behavior of the "Get User By ID" API endpoint
 * using Spring's {@link MockMvc}. It ensures correct request handling,
 * service interaction, and response mapping for different execution scenarios.
 *
 * <p><b>Testing Scope:</b>
 * <ul>
 ...
 * <ul>
 *   <li>{@link GetUserByIdService} – handles business logic for fetching users</li>
 ...
 * <ul>
 *   <li><b>Success Case:</b>
 *       Valid user ID returns HTTP 200 with user details and success message</li>
 *
